...
public interface RoomWSB {
    ...
    @RequestWrapper(localName = "searchRoom", targetNamespace = "http://soap/", className = "soapclient.airline.flight.SearchRoom")
    @ResponseWrapper(localName = "searchRoomResponse", targetNamespace = "http://soap/", className = "soapclient.airline.flight.SearchRoomResponse")
